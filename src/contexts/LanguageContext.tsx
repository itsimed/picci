...
const translations: Translations = {
  ...
  'nav.cars': { fr: 'Vente Auto', en: 'Car Sales' },
  ...
  'home.hero.description': { fr: 'Une station complète qui répond à tous vos besoins automobiles : lavage, mécanique, barbier et vente de véhicules', en: 'A complete station that meets all your automotive needs: car wash, mechanics, barber and vehicle sales' },
  ...
  // About section
  'home.about.title': { fr: 'Une station complète à votre service', en: 'A complete station at your service' },
  ...
  'home.services.subtitle': { fr: 'Une station multi-services complète pour répondre à tous vos besoins automobiles', en: 'A complete multi-service station to meet all your automotive needs' },
  ...
  // Cutting Services
  'barbershop.services.cutting.haircut.name': { fr: 'Coupe', en: 'Haircut' },
  ...
  'barbershop.services.cutting.haircut_beard.name': { fr: 'Coupe + Barbe', en: 'Haircut + Beard' },
  'barbershop.services.cutting.haircut_beard.description': { fr: 'Coupe et barbe incluant poils d\'oreilles/sourcils', en: 'Haircut and beard including ear hair/eyebrows' },
  'barbershop.services.cutting.haircut_beard.price': { fr: '35 $', en: '$35' },

  'barbershop.services.cutting.kids.name': { fr: 'Coupe jusqu\'à 13 ans', en: 'Haircut up to 13 years' },
  'barbershop.services.cutting.kids.description': { fr: 'Coupe pour enfants jusqu\'à 13 ans', en: 'Haircut for children up to 13 years old' },
  'barbershop.services.cutting.kids.price': { fr: '18 $', en: '$18' },

  'barbershop.services.cutting.senior.name': { fr: 'Coupe 60+', en: 'Cut 60+' },
  'barbershop.services.cutting.senior.description': { fr: 'Coupe pour personnes de 60 ans ou plus', en: 'Haircut for people 60 years or older' },
  'barbershop.services.cutting.senior.price': { fr: '20 $', en: '$20' },

  'barbershop.services.cutting.clipper.name': { fr: 'Tondeuse | longueur', en: 'Clipper | length' },
  'barbershop.services.cutting.clipper.description': { fr: 'Un réglage de tondeuse sur toute la tête', en: 'One clipper setting for the whole head' },
  'barbershop.services.cutting.clipper.price': { fr: '18 $', en: '$18' },

  // Beard Services
  'barbershop.services.beard.basic.name': { fr: 'Barbe', en: 'Beard' },
  'barbershop.services.beard.basic.description': { fr: 'Façonnage et rasage de la barbe', en: 'Beard shaping and shaving' },
  'barbershop.services.beard.basic.price': { fr: '18 $', en: '$18' },

  'barbershop.services.beard.classic.name': { fr: 'Rasage Classique', en: 'Classic Shave' },
  'barbershop.services.beard.classic.description': { fr: 'Un rasage traditionnel', en: 'A traditional shave' },
  'barbershop.services.beard.classic.price': { fr: '18 $', en: '$18' },

  'barbershop.services.beard.styling.name': { fr: 'Taille Barbe + Styling', en: 'Beard Trim + Styling' },
  'barbershop.services.beard.styling.description': { fr: 'Taille professionnelle et styling de barbe', en: 'Professional beard trimming and styling' },
  'barbershop.services.beard.styling.price': { fr: '25 $', en: '$25' },

  'barbershop.services.beard.mustache.name': { fr: 'Taille Moustache', en: 'Mustache Trim' },
  'barbershop.services.beard.mustache.description': { fr: 'Taille et façonnage précis de moustache', en: 'Precise mustache trimming and shaping' },
  'barbershop.services.beard.mustache.price': { fr: '12 $', en: '$12' },

  // Other Services
  'barbershop.services.others.vip.name': { fr: 'Traitement VIP', en: 'VIP Treatment' },
  'barbershop.services.others.vip.description': { fr: 'Lavage, coupe, barbe, épilation oreilles et nez, choix de cire', en: 'Wash, cut, beard, ear and nose waxing, choice of wax' },
  'barbershop.services.others.vip.price': { fr: '53 $', en: '$53' },

  'barbershop.services.others.wash.name': { fr: 'Lavage Cheveux + Styling', en: 'Hair Wash + Styling' },
  'barbershop.services.others.wash.description': { fr: 'Service professionnel de lavage et styling', en: 'Professional hair washing and styling service' },
  'barbershop.services.others.wash.price': { fr: '15 $', en: '$15' },

  'barbershop.services.others.eyebrows.name': { fr: 'Épilation Sourcils', en: 'Eyebrow Waxing' },
  'barbershop.services.others.eyebrows.description': { fr: 'Façonnage et épilation précise des sourcils', en: 'Precise eyebrow shaping and waxing' },
  'barbershop.services.others.eyebrows.price': { fr: '8 $', en: '$8' },

  'barbershop.services.others.towel.name': { fr: 'Traitement Serviette Chaude', en: 'Hot Towel Treatment' },
  'barbershop.services.others.towel.description': { fr: 'Traitement facial relaxant à la serviette chaude', en: 'Relaxing hot towel facial treatment' },
  'barbershop.services.others.towel.price': { fr: '10 $', en: '$10' },
  ...
  'carwash.services.exterior.express.name': { fr: 'Lavage Express', en: 'Express Wash' },
  'carwash.services.exterior.express.description': { fr: 'Lavage extérieur complet avec séchage à la main', en: 'Complete exterior wash with hand drying' },
  'carwash.services.exterior.express.price': { fr: '25 $', en: '$25' },

  'carwash.services.exterior.premium.name': { fr: 'Lavage Premium', en: 'Premium Wash' },
  'carwash.services.exterior.premium.description': { fr: 'Lavage extérieur + protection céramique express', en: 'Exterior wash + express ceramic protection' },
  'carwash.services.exterior.premium.price': { fr: '35 $', en: '$35' },

  'carwash.services.exterior.polish.name': { fr: 'Polish & Cire', en: 'Polish & Wax' },
  'carwash.services.exterior.polish.description': { fr: 'Polish complet de la carrosserie + protection cire', en: 'Complete body polish + wax protection' },
  'carwash.services.exterior.polish.price': { fr: '120 $', en: '$120' },

  'carwash.services.exterior.wheels.name': { fr: 'Traitement Jantes', en: 'Wheel Treatment' },
  'carwash.services.exterior.wheels.description': { fr: 'Nettoyage approfondi des jantes et pneus', en: 'Deep cleaning of wheels and tires' },
  'carwash.services.exterior.wheels.price': { fr: '30 $', en: '$30' },

  'carwash.services.exterior.ceramic.name': { fr: 'Protection Céramique', en: 'Ceramic Protection' },
  'carwash.services.exterior.ceramic.description': { fr: 'Application protection céramique longue durée', en: 'Long-lasting ceramic protection application' },
  'carwash.services.exterior.ceramic.price': { fr: '250 $', en: '$250' },

  // Interior Washing Services
  'carwash.services.interior.title': { fr: 'LAVAGE INTÉRIEUR', en: 'INTERIOR WASHING' },

  'carwash.services.interior.vacuum.name': { fr: 'Aspiration Complete', en: 'Complete Vacuum' },
  'carwash.services.interior.vacuum.description': { fr: 'Aspiration approfondie de l\'habitacle et coffre', en: 'Deep vacuuming of cabin and trunk' },
  'carwash.services.interior.vacuum.price': { fr: '30 $', en: '$30' },

  'carwash.services.interior.seats.name': { fr: 'Nettoyage Sièges', en: 'Seat Cleaning' },
  'carwash.services.interior.seats.description': { fr: 'Nettoyage en profondeur des sièges et tissus', en: 'Deep cleaning of seats and fabrics' },
  'carwash.services.interior.seats.price': { fr: '45 $', en: '$45' },

  'carwash.services.interior.disinfection.name': { fr: 'Désinfection', en: 'Disinfection' },
  'carwash.services.interior.disinfection.description': { fr: 'Désinfection complète de l\'habitacle', en: 'Complete cabin disinfection' },
  'carwash.services.interior.disinfection.price': { fr: '35 $', en: '$35' },

  // Interior Washing Services (continued)
  'carwash.services.interior.cuir.name': { fr: 'Cuir Treatment', en: 'Leather Treatment' },
  'carwash.services.interior.cuir.description': { fr: 'Nettoyage et protection des surfaces en cuir', en: 'Cleaning and protection of leather surfaces' },
  'carwash.services.interior.cuir.price': { fr: '55 $', en: '$55' },

  // Premium Services
  'carwash.services.premium.title': { fr: 'SERVICES PREMIUM', en: 'PREMIUM SERVICES' },

  'carwash.services.premium.complete.name': { fr: 'Détailing Complet', en: 'Complete Detailing' },
  'carwash.services.premium.complete.description': { fr: 'Service complet intérieur/extérieur avec protection', en: 'Complete interior/exterior service with protection' },
  'carwash.services.premium.complete.price': { fr: '250 $', en: '$250' },

  'carwash.services.premium.engine.name': { fr: 'Nettoyage Moteur', en: 'Engine Cleaning' },
  'carwash.services.premium.engine.description': { fr: 'Nettoyage et dégraissage du compartiment moteur', en: 'Cleaning and degreasing of the engine compartment' },
  'carwash.services.premium.engine.price': { fr: '75 $', en: '$75' },

  'carwash.services.premium.correction.name': { fr: 'Correction Peinture', en: 'Paint Correction' },
  'carwash.services.premium.correction.description': { fr: 'Correction des défauts de peinture et micro-rayures', en: 'Correction of paint defects and micro-scratches' },
  'carwash.services.premium.correction.price': { fr: '180 $', en: '$180' },

  'carwash.services.premium.winter.name': { fr: 'Protection Hivernale', en: 'Winter Protection' },
  'carwash.services.premium.winter.description': { fr: 'Protection complète pour l\'hiver', en: 'Complete winter protection' },
  'carwash.services.premium.winter.price': { fr: '150 $', en: '$150' },
  ...
  // === FINANCING PAGE ===
  'financing.hero.title.1': { fr: 'Roulez', en: 'Drive' },
  'financing.hero.title.2': { fr: 'aujourd\'hui,', en: 'today,' },
  'financing.hero.title.3': { fr: 'payez à votre rythme', en: 'pay at your pace' },
