      ...
      <section id="services" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-8 mt-12">
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.exterior.express.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.exterior.express.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.exterior.express.description')}</p>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.exterior.premium.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.exterior.premium.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.exterior.premium.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.exterior.polish.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.exterior.polish.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.exterior.polish.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.exterior.wheels.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.exterior.wheels.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.exterior.wheels.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.exterior.ceramic.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.exterior.ceramic.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.exterior.ceramic.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
              </div>
            </div>

            {/* Colonne 2 - LAVAGE INTÉRIEUR */}
            <div className="transform transition-all duration-500 hover:translate-y-[-10px]">
              <h3 className="text-2xl font-bold text-white mb-8 text-center relative catalog-column-title">
              ...
              <div className="space-y-8 mt-12">
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.interior.vacuum.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.interior.vacuum.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.interior.vacuum.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.interior.seats.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.interior.seats.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.interior.seats.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.interior.disinfection.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.interior.disinfection.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.interior.disinfection.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.interior.cuir.name')}</h4>
                    <span className="text-blue-500 font-bold catalog-item-price">{t('carwash.services.interior.cuir.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.interior.cuir.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
              </div>
            </div>
            ...
            <div className="transform transition-all duration-500 hover:translate-y-[-10px]">
              <h3 className="text-2xl font-bold text-white mb-8 text-center relative catalog-column-title">
                {t('carwash.services.premium.title')}
              ...
              <div className="space-y-8 mt-12">
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.premium.complete.name')}</h4>
                    <span className="text-red-500 font-bold catalog-item-price">{t('carwash.services.premium.complete.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.premium.complete.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.premium.engine.name')}</h4>
                    <span className="text-red-500 font-bold catalog-item-price">{t('carwash.services.premium.engine.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.premium.engine.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.premium.correction.name')}</h4>
                    <span className="text-red-500 font-bold catalog-item-price">{t('carwash.services.premium.correction.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.premium.correction.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
                ...
                <div className="transform transition-all duration-300 hover:translate-x-2">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-white font-semibold catalog-item-name">{t('carwash.services.premium.winter.name')}</h4>
                    <span className="text-red-500 font-bold catalog-item-price">{t('carwash.services.premium.winter.price')}</span>
                  </div>
                  <p className="text-gray-400 text-sm catalog-item-description">{t('carwash.services.premium.winter.description')}</p>
                  <div className="mt-4 h-px bg-gray-800"></div>
                </div>
              </div>
            </div>
