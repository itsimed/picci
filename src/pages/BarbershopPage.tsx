...
const barbershopServices = {
  ...
  barbe: [
    {
      nameKey: "barbershop.services.beard.basic.name",
      priceKey: "barbershop.services.beard.basic.price",
      descriptionKey: "barbershop.services.beard.basic.description"
    },
    {
      nameKey: "barbershop.services.beard.classic.name",
      priceKey: "barbershop.services.beard.classic.price",
      descriptionKey: "barbershop.services.beard.classic.description"
    },
    {
      nameKey: "barbershop.services.beard.styling.name",
      priceKey: "barbershop.services.beard.styling.price",
      descriptionKey: "barbershop.services.beard.styling.description"
    },
    {
      nameKey: "barbershop.services.beard.mustache.name",
      priceKey: "barbershop.services.beard.mustache.price",
      descriptionKey: "barbershop.services.beard.mustache.description"
    }
  ],
  autres: [
    {
      nameKey: "barbershop.services.others.vip.name",
      priceKey: "barbershop.services.others.vip.price",
      descriptionKey: "barbershop.services.others.vip.description"
    },
    {
      nameKey: "barbershop.services.others.wash.name",
      priceKey: "barbershop.services.others.wash.price",
      descriptionKey: "barbershop.services.others.wash.description"
    },
    {
      nameKey: "barbershop.services.others.eyebrows.name",
      priceKey: "barbershop.services.others.eyebrows.price",
      descriptionKey: "barbershop.services.others.eyebrows.description"
    },
    {
      nameKey: "barbershop.services.others.towel.name",
      priceKey: "barbershop.services.others.towel.price",
      descriptionKey: "barbershop.services.others.towel.description"
    }
  ]
};
