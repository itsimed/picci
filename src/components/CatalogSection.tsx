  ...
  return (
    <section id="catalog" className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 right-1/4 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-red-500/3 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/3 left-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 bg-orange-500/3 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '4s' }}></div>
        
        {/* Soft light lines */}
        <div className="absolute top-0 left-1/3 w-px h-24 sm:h-32 md:h-40 bg-gradient-to-b from-transparent via-red-500/10 to-transparent animate-fade-in-out"></div>
        <div className="absolute bottom-0 right-1/3 w-px h-24 sm:h-32 md:h-40 bg-gradient-to-t from-transparent via-red-500/10 to-transparent animate-fade-in-out" style={{ animationDelay: '2s' }}></div>
        
        {/* Animated border glow */}
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-red-500/20 to-transparent animate-glow"></div>
        <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-red-500/20 to-transparent animate-glow" style={{ animationDelay: '3s' }}></div>
      </div>
