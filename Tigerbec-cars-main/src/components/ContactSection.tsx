  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-0 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-red-500/5 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-0 w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 bg-orange-500/5 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '3s' }}></div>
        
        {/* Floating lines */}
        <div className="absolute top-0 left-1/4 w-1 h-16 sm:h-24 md:h-32 bg-gradient-to-b from-transparent via-red-500/20 to-transparent animate-slide-down"></div>
        <div className="absolute bottom-0 right-1/3 w-1 h-16 sm:h-24 md:h-32 bg-gradient-to-t from-transparent via-orange-500/20 to-transparent animate-slide-up"></div>
      </div>
